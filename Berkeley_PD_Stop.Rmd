...
stop_df <- mutate(stop_df, Dispositions = str_extract_all(stop_df$Dispositions, "[a-zA-Z0-9]{6}"))
#removes empty cases
stop_df <- mutate(stop_df, Dispositions = str_replace_all(stop_df$Dispositions, "character(0)", ""))
