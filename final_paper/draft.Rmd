...
```{r, warning = FALSE, echo = F, fig.width = 8, fig.height = 3, message = FALSE, fig.align="center", fig.cap= "Berkeley Police Stops"}
map_stop1 # figure 5
```
...
```{r, warning = FALSE, echo = F, fig.width = 8, fig.height = 3, message = FALSE, fig.align="center", fig.cap= "2015-2016 Police Stop Density (left) and 2010 Census Tract Population Density (right)"}
...
```{r, fig.height = 3, fig.width = 10, echo=FALSE, warning = FALSE, message = FALSE, fig.align="center", fig.cap= "Police Stop Density Map by Race"}
...
```{r, fig.height = 3, fig.width = 10, fig.cap= "Police Stops by Reason", echo=FALSE, warning = FALSE, message = FALSE, fig.align = "center"}
map_reasons1
```
...
```{r, fig.height = 3, fig.width = 10, fig.cap= "Conditional Probability of Being Arrested During a Police Stop: Race VS Hour", echo=FALSE, warning = FALSE, message = FALSE, fig.align = "center"}
...
```{r, fig.height = 3, fig.width = 10, fig.cap= "Conditional Probability of Arrested  During a Police Stop: Age VS Hour", echo=FALSE, warning = FALSE, message = FALSE, fig.align = "center"}
