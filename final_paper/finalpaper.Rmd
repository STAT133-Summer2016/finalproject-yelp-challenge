...
table2 <- data.frame(dataframelist[2])   #Enforcement
table3 <- data.frame(dataframelist[3])   #Enforcement
...
test <-read_csv("clean_data/enforcement_race.csv")

map_enforcement <- ggplot(test)+ 
  geom_bar(aes(x=Race,
               y=percentage,
               fill = Race),
           stat = "identity") +
  ...
  geom_text(aes(x=Race,
            ...
            colour= "#000000")+
  scale_y_continuous(labels=percent, limits = c(0,1)) +
  labs(title = "Percent Stopped by Enforcement Type and Race",
       x = "Race",
       y = "Percentage") +
