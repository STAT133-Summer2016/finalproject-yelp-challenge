...
```{r, echo=FALSE, include = FALSE, message=FALSE, warning = FALSE, eval = F}
...
```{r, warning = FALSE, echo = F, fig.width = 10, fig.height = 5, message = FALSE, fig.align="center", eval = F}
...
```{r, message = F, echo = FALSE, fig.width = 10, fig.height = 5, warning = FALSE, fig.align="center"}
...
```{r, fig.height = 10, fig.width = 10, echo=FALSE, warning = FALSE, message = FALSE, fig.align = "center"}
map_reasons1
```
